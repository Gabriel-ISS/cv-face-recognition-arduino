...
class FrameRateDrawer:
    ...
    def __init__(self, position: tuple[int, int] = (10, 30), color: tuple[int, int, int] = (0, 255, 0)):
    ...
    def update(self, frame):
        ...
        cv2.putText(frame, f"FPS: {self.fps:.2f}", self.position, cv2.FONT_HERSHEY_SIMPLEX, 1, self.color, 2)
